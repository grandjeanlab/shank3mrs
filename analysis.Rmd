...
**## automated code to select a working row from csv file of scan information (IGNORE THIS) ##** 
...
**another code, works better, but looks through file directory not csv file because read_mrs cant read from csv** 
